...
function init() {
  ...
  (0, _enterView.default)({
    ...
    enter: function enter(el) {
      ...
      var chapter_header_img = d3.select(el).select('.chapter_hed_img').node();

      if (chapter_header_img) {
        var src_url = _isMobile.default.any() ? chapter_header_img.dataset.src + '_mobile.jpg' : chapter_header_img.dataset.src + '.jpg';
        chapter_header_img.src = src_url;
      }
...
exports.default = _default;
},{"enter-view":"RZIL","./utils/is-mobile":"WEtf"}],"v9Q8":[function(require,module,exports) {
"use strict";
